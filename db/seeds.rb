...
e = Event.create({
  ...
  starts_at: DateTime.parse('Fri, 11 Dec 2016 7:00 AM+0700'),
  ...
  extended_html_description: <<-DESC
    ...
    <p style="text-align:center"><span style="font-size:20px">Giải đua xe đạp địa hình 11-13/12/2016</span></p>
